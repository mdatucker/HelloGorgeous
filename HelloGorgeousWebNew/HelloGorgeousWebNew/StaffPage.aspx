<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffPage.aspx.cs" Inherits="HelloGorgeousWebNew.StaffPage" %>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								Hello Gorgeous Staff				
							</h1>	
							<p class="text-white link-nav"><a href="Homepage.aspx">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="StaffPage.aspx">Staff</a></p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="team-area section-gap" id="team">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Meet Our Staff</h1>
					...
					<div class="row justify-content-center d-flex align-items-center">
						...
						<div class="col-lg-3 col-md-6 single-team">
						    <div class="thumb">
						        <img class="img-fluid" src="img/Staff/Christa.jpg" alt="">
						        <div class="align-items-center justify-content-center d-flex">
									 
                                    <marquee behavior="scroll" scrollamount="3" direction="up" text-align="right">Christa Greene has been in the industry for 16 years and is a dual licensed Cosmetologist and Barber, as well as a Master Barber Instructor. As a child she always wanted to do hair. She began her career with the drive to never be satisfied with her current education and loves to learn new trends, techniques and products. Christa’s loves making people happy and getting to know her clients is the most rewarding part of what she does. She has a goal to be the best she can be at everything she does. From straight razor shaves to hair color and makeup, she can do it all and loves every minute of it. Christa has been a part of the Hello Gorgeous team since 2011 and has been the managing the salon since 2015.</marquee>
									 
									 
						        </div>
						    </div>
						    <div class="meta-text mt-30 text-center">
							    <h4>Christa Greene</h4>
							    <p>Manager</p>			    	
						    </div>
						</div>	
						<div class="col-lg-3 col-md-6 single-team">
