<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServicesPage.aspx.cs" Inherits="HelloGorgeousWebNew.ServicesPage" %>
                        ...
                        <div class="single-menu-list row justify-content-between align-items-center">
                          ...
                          <div class="single-menu-list row justify-content-between align-items-center">
                            <div class="col-lg-9">
                                ...
                                <p>Precision Hair Cut, Relaxing Face Shave with hot towels and massage for Groom and Father.
                                </p>
                            </div>
                            <div class="col-lg-3 flex-row d-flex price-size">
                          ...
                          <div class="single-menu-list row justify-content-between align-items-center">
                            <div class="col-lg-9">
                                ...
                                <p>Precision Hair Cut, Relaxing Face Shave with hot towels & massage, and Eyebrow Wax for Groom and Best Man.
                                </p>
                            </div>
                            <div class="col-lg-3 flex-row d-flex price-size">
                          ...
                          <div class="single-menu-list row justify-content-between align-items-center">
                            <div class="col-lg-9">
                                ...
                                <p>Precision Hair Cut, Relaxing Face Shave with hot towels & massages, and Eyebrow Wax for Groom
                                </p>
                            </div>
                            <div class="col-lg-3 flex-row d-flex price-size">
                          ...
                          <div class="single-menu-list row justify-content-between align-items-center">
                            <div class="col-lg-9">
                                ...
                                <p>For a wedding party over 5 your Ring Bearer will receive a complimentary haircut.
                                </p>
                            </div>
                            <div class="col-lg-3 flex-row d-flex price-size">
                         ...
                         <div class="single-menu-list row justify-content-between align-items-center">
                            <div class="col-lg-9">
                                ...
                                <p>Specialty Hair Style & Makeup for the Bride and Maid of Honor.
 ...
 <div class="single-menu-list row justify-content-between align-items-center">
                            <div class="col-lg-9">
                                ...
                                <p>Specialty Hair Style for the Bride and Maid of Honor.
 ...
 <div class="single-menu-list row justify-content-between align-items-center">
                            <div class="col-lg-9">
                                ...
                                <p>Specialty Hair Style and Makeup for the Bride.
                                </p>
                            </div>
                            <div class="col-lg-3 flex-row d-flex price-size">
